...
public class HardLevelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit=(TextView) findViewById(R.id.coins3);
        edit.setText(temp);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (sp.getInt("your_int_key", Activity.MODE_PRIVATE) <= 0) {
                    Intent intent = new Intent(HardLevelActivity.this, MoreMoneyActivity.class);
                    ...
                    rotate.setAnimationListener(new Animation.AnimationListener() {
                        ...
                        public void onAnimationEnd(Animation animation) {
                            int box;
                            box=currentNumber(currentNumber(360-(degree % 360)));

                            if(box==-10)
                            {
                                Intent intent = new Intent(HardLevelActivity.this, Pop5Activity.class);
                                startActivity(intent);
                            }
                            else if(box==100)
                            {
                                Intent intent = new Intent(HardLevelActivity.this, HardPopActivity.class);
                                startActivity(intent);
                            }
                            else
                            {
                                Intent intent = new Intent(HardLevelActivity.this, HardPop2Activity.class);
                                startActivity(intent);
                            }
...
//        }
    ...
    private int currentNumber(int degrees) {
        ...
        {
            text="Κέρδισες άλλη μια ευκαιρία";
            result += 0;
        }
